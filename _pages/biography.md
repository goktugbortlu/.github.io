...
<div style="display: grid; grid-template-columns: 1fr 1fr; gap: 40px; margin-bottom: 30px; align-items: start;">
  ...
  <div style="font-size: 1.05em;">
    ...
    <p>I regularly take bad photos wherever I go and have this self-assigned goal of contributing to Turkish phonology by occasionally writing in Turkish.</p>
